...
public class SamsungPlug {
	...
	/* private static final String HOTPLUG_SAMSUNG_ENABLE = HOTPLUG_SAMSUNG + "/max_online_cpu"; */
    private static final String HOTPLUG_SAMSUNG_MIN_ONLINE_CPU = "/sys/power/cpuhotplug/min_online_cpu";
    /* private static final String HOTPLUG_SAMSUNG_ENABLE = HOTPLUG_SAMSUNG + "/min_online_cpu"; */
